...
/*    // Simple sparklines
    ...
    var modificaciones_medida_fuera_fecha = $('.modificaciones_medida_fuera_fecha').data('modificaciones_medida_fuera_fecha');
    
    // Initialize charts
    progressIcon('#progress_icon_one', 42, 2.5, "#eee", "#EF5350", modificaciones_medida_fuera_fecha, "icon-heart6");
    progressIcon('#progress_icon_two', 42, 2.5, "#eee", "#5C6BC0", 0.3, "icon-trophy3");
    progressIcon('#progress_icon_three', 42, 2.5, "#00897B", "#fff", modificaciones_medida_fuera_fecha, "icon-cog");
    progressIcon('#progress_icon_four', 42, 2.5, "#673AB7", "#fff", 0.1, "icon-calendar");
    ...
    progressPercentage('#progress_percentage_four', 46, 3, "#E53935", "#fff", 0.88);
