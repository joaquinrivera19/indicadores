        ...
        <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Errores de Nuevos Desarrollos</li>
                        </ul>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Gráfico Errores de Nuevos Desarrollos</h5>
                </div>
...
@section('scripts')
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.resultado').load('{{ URL::to("calidad/error_nuevo_desarrollo_index_contenido") }}', function () {
                $(".loading_gif").hide();
                grafic_panel();
