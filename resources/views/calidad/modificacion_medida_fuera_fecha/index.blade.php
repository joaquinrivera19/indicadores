        ...
        <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Modificaciones a Medida Fuera de Fecha REQ</li>
                        </ul>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Gráfico Modificaciones a Medida Fuera de Fecha REQ</h5>
                </div>
...
@section('scripts')
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.resultado').load('{{ URL::to("calidad/modificacion_medida_fuera_fecha_index_contenido") }}', function () {
                $(".loading_gif").hide();
                grafic_panel();
