        ...
        <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Errores Evitables</li>
                        </ul>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Gráfico Errores Evitables</h5>
                </div>
...
@section('scripts')
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.resultado').load('{{ URL::to("bug_fixing/error_evitable_index_contenido") }}', function () {
                $(".loading_gif").hide();
                grafic_panel();
